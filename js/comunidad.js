/**
 * Pantalla Comunidad / Noticias - Pinta Gol
 * HTML, JavaScript, WebGL (Three.js). Coherencia con resto de pantallas.
 */
(function () {
  'use strict';
  ...
  function initScene() {
    var canvasEl = document.getElementById('comunidad-canvas');
    if (!canvasEl) return;
